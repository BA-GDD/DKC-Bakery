	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float step_dis148 = saturate( step( staticSwitch152 , texCoord145.x ) );
				...
				float Alpha = ( saturate( ( vert_alpha120 * saturate( ( staticSwitch31 * _Opacity ) ) ) ) * saturate( distanceDepth25 ) * step_dis148 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float staticSwitch152 = _step_diss;
				#endif
				float2 texCoord145 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float step_dis148 = saturate( step( staticSwitch152 , texCoord145.x ) );
				

				surfaceDescription.Alpha = ( saturate( ( vert_alpha120 * saturate( ( staticSwitch31 * _Opacity ) ) ) ) * saturate( distanceDepth25 ) * step_dis148 );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float screenDepth25 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth25 = abs( ( screenDepth25 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Fade_Ditance ) );
				float vert_ref_u151 = IN.ase_texcoord2.x;
				#ifdef _USE_CUSTOMDATA_ON
				float staticSwitch152 = vert_ref_u151;
				#else
				float staticSwitch152 = _step_diss;
...
Node;AmplifyShaderEditor.CommentaryNode;125;-1446.245,75.85016;Inherit;False;2286.741;567.9067;;22;27;122;11;14;117;116;20;106;115;29;30;123;31;72;12;13;124;73;25;26;28;149;Alpha;0.9768651,1,0.3349057,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;118;-1439.899,758.0268;Inherit;False;2463.757;1033.936;;39;101;130;98;131;132;114;103;102;100;87;89;88;99;93;97;94;90;91;96;95;113;18;16;19;15;111;23;17;134;138;137;139;144;145;146;148;150;152;153;Dissolve;0.0518868,0.2646385,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-2371.611,-279.6722;Inherit;False;Property;_normal_str;normal_str;14;0;Create;True;0;0;0;False;0;False;0;0.082;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;678.4963,133.7092;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-468.8702,527.7568;Inherit;False;Property;_Opacity;Opacity;6;0;Create;True;0;0;0;False;0;False;1;1.71;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-30.85999,1135.006;Inherit;False;Property;_edge_width;edge_width;23;0;Create;True;0;0;0;False;0;False;0.06;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;138;289.9167,964.7635;Inherit;False;Property;_edge_color;edge_color;24;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-782.584,-466.9095;Inherit;True;Property;_Main_Texture;Main_Texture;0;0;Create;True;0;0;0;False;0;False;-1;07454a717364c364b9bc4becd33778da;066e15edc2616b445a46680a76cb1aad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;7;-349.4769,-826.0873;Inherit;False;Property;_main_color;main_color;5;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.319508,1.319508,1.319508,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-43.03589,1500.684;Inherit;False;Property;_step_diss;step_diss;26;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;150;506.9019,1654.982;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;149;455.5071,381.7459;Inherit;False;148;step_dis;1;0;OBJECT;;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=9433722E5C3A6AB2F62B2F49B92EDE3858AC48B4