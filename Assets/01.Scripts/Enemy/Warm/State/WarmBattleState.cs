...
public class WarmBattleState : WarmGroundState
{
    ...
    public WarmBattleState(Enemy enemyBase, EnemyStateMachine<WarmStateEnum> stateMachine, string animBoolName) : base(enemyBase, stateMachine, animBoolName)
    {
    }
    ...
    public override void UpdateState()
    {
        ...
        {
            _stateMachine.ChangeState(WarmStateEnum.Attack);
        }
        ...
        {
            _stateMachine.ChangeState(WarmStateEnum.Idle); // 전투시간을 초과했다면 idle로 이동.
        }
    }
