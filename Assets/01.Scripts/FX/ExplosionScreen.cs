...
public class ExplosionScreen : MonoBehaviour
{
    ...
    private IEnumerator Shatter()
    {
        ...
        var obj = Instantiate(_shatterEffectObj, Camera.main.transform.position, Quaternion.identity);
        ...
        {
            rb.AddExplosionForce(_explosionPow, _renderCam.transform.position, _explosionRad);
        }
